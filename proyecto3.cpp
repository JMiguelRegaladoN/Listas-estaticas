...
/*
GatoDomestico. La clase GatoDomestico tiene un solo atributo llamado raza y los métodos para obtener
y establecer el valor de este atributo, además de un operador sobrecargado de igualdad
y los operadores de entrada y salida para poder leer y escribir objetos de la clase en consola.
La clase Lista es la que implementa la lista y tiene los métodos para agregar
, eliminar, insertar y buscar objetos de la clase GatoDomestico, así como
otros métodos para consultar la lista y saber si está vacía o llena.
El programa principal es un menú de opciones que permite al usuario interactuar
con la lista de objetos GatoDomestico. Las opciones son agregar un objeto
, buscar un objeto, eliminar un objeto, insertar un objeto y mostrar la lista completa.
*/
using namespace std;
